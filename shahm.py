...
import random
APP_ID = "26513358"
APP_HASH= 'a7e25a4993592a1f67ef4b1703db4605'
bot_token='6525713076:AAHnKy7bq69iS-hmJ2ZhdxX15MKXrujoP9A'
abbas=TelegramClient('6645960603:AAETeo36Wb4R7wxddoCxwUmw835S7mizr8A', APP_ID, APP_HASH)
abbas.start()
a = requests.session()
bot_username = '@eeobot'
